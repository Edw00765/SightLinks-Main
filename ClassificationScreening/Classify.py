...
from ClassificationScreening import ClassUtils
...
vgg16_state_path = "ClassificationScreening/VGG16_Full_State_Dict.pth"
# A prototype v2 version that's only been trained on 2000 images by transfer learning
mobileNet_path = "ClassificationScreening/MobileNetV3_state_dict_big_train.pth"
data_path = "ClassificationScreening/zebra_annotations/classification_data"
...
# example_init(examples=20,display=False)
